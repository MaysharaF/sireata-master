...
public class ReportUtils {
    ...
    /**
     * Get database connection, call report generation method and export's report to
     * Vaadin's FileDownloader
     * 
     ...
     */
    public void prepareForPdfReport(String reportName, String reportOutputFilename, List dataSource,
            Button buttonToExtend) {
        this.prepareForPdfReport(reportName, reportOutputFilename, dataSource, buttonToExtend, true);
    }

    public void prepareForPdfReport(String reportName, String reportOutputFilename, List dataSource,
            Button buttonToExtend, boolean removeExtensions) {
     ...
     */
    private StreamResource createPdfResource(final List beanCollection, final String templatePath,
    ...
    public ByteArrayOutputStream createPdfStream(final List beanCollection, final String templatePath)
            throws Exception {
        ByteArrayOutputStream pdfBuffer = new ByteArrayOutputStream();
    ...
    private void executeReport(String templatePath, List beanCollection, OutputStream outputStream) throws JRException {
        ...
        JasperReport jasperReport = (JasperReport) JRLoader.loadObject(this.getClass().getClassLoader()
                .getResource("br/edu/utfpr/dv/sireata/report/" + templatePath + ".jasper"));
        ;
    ...
    private JasperPrint fillReport(JasperReport jasperReport, List beanCollection) {
        ...
        try {
            jasperPrint = JasperFillManager.fillReport(jasperReport, fillParameters,
